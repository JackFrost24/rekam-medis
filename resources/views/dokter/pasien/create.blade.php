...
<div class="max-w-4xl mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <form id="patientForm" method="POST" action="{{ route('dokter.pasien.store') }}">
            @csrf
            ...
            <section class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2">
                            <label class="inline-flex items-center">
                                <input type="checkbox" id="heart_disease" name="heart_disease" value="1" class="rounded border-gray-300 text-indigo-600">
                                <span class="ml-2">Heart Disease</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="checkbox" id="diabetes" name="diabetes" value="1" class="rounded border-gray-300 text-indigo-600">
                                <span class="ml-2">Diabetes</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="checkbox" id="hepatitis" name="hepatitis" value="1" class="rounded border-gray-300 text-indigo-600">
                    ...
                    <div>
                        ...
                        <textarea id="allergies" name="allergies" rows="2" class="mt-1 block w-full p-2 border rounded"></textarea>
                    </div>
                    <div>
                        <label for="blood_disorders" class="block text-sm font-medium">Blood Disorders</label>
                        <textarea id="blood_disorders" name="blood_disorders" rows="2" class="mt-1 block w-full p-2 border rounded"></textarea>
                    </div>
                    <div>
                        <label for="other_diseases" class="block text-sm font-medium">Other Diseases</label>
                        <textarea id="other_diseases" name="other_diseases" rows="2" class="mt-1 block w-full p-2 border rounded"></textarea>
                    </div>
                    <div>
                        <label for="current_medication" class="block text-sm font-medium">Current Medication</label>
                        <textarea id="current_medication" name="current_medication" rows="2" class="mt-1 block w-full p-2 border rounded"></textarea>
                    </div>
                </div>
            </section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="occlusion" class="w-full px-3 py-2 border rounded-md" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium">Torus Palatinus</label>
                            <input type="text" name="torus_palatinus" class="w-full px-3 py-2 border rounded-md" />
                        </div>
                    </div>
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium">Torus Mandibularis</label>
                            <input type="text" name="torus_mandibularis" class="w-full px-3 py-2 border rounded-md" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium">Supernumerary Teeth</label>
                            <input type="text" name="supernumerary" class="w-full px-3 py-2 border rounded-md" />
                        </div>
                    </div>
                    <div class="md:col-span-2 space-y-4">
                        <div>
                            <label class="block text-sm font-medium">Diastema</label>
                            <input type="text" name="diastema" class="w-full px-3 py-2 border rounded-md" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium">Other Anomalies</label>
                            <input type="text" name="other_anomalies" class="w-full px-3 py-2 border rounded-md" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="mb-8">
                ...
                <textarea name="doctor_notes" rows="4" class="w-full px-3 py-2 border rounded-md"></textarea>
            </section>

            <!-- Submit -->
            <div class="text-right">
                <button type="submit" class="px-6 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">Submit Patient Data</button>
            </div>
        </form>
    </div>
</div>
